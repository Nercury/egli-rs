...
use egl::{
    EGLBoolean, EGLClientBuffer, EGLConfig, EGLContext, EGLDisplay, EGLNativeDisplayType,
    EGLNativePixmapType, EGLNativeWindowType, EGLSurface, EGLenum, EGLint,
};

#[cfg(feature = "egl_1_5")]
use egl::{EGLAttrib, EGLImage, EGLSync, EGLTime};
...
extern "C" {
    ...
    #[cfg(feature = "egl_1_5")]
    pub fn eglCreateSync(dpy: EGLDisplay, _type: EGLenum, attrib_list: *const EGLAttrib)
        -> EGLSync;
